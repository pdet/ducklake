...
string DuckLakeStagedCommit::EmitColumnStatsValues(const DuckLakeColumnStats &s) {
	...
	return StringUtil::Format("%llu, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s", s.column_size_bytes,
	                          ...
	                          DuckLakeUtil::BoolLiteral(s.min_is_exact), DuckLakeUtil::BoolLiteral(s.max_is_exact));
}
