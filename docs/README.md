...
2. `v1.5-variegata`. Here, we use DuckDB `v1.5-variegata` as a submodule. Target this branch if you have a bug-fix that does not require a DuckLake spec change.
